...
INSERT INTO `vehicle` (`id`, `asset_name`, `is_qualified`, `is_fixed`, `max_contribution`, `is_pretax`, `has_employer_match`, `compounding_periods`) VALUES (5, 'traditional_ira', 1, 0, 7000, 1, 0, NULL);
INSERT INTO `vehicle` (`id`, `asset_name`, `is_qualified`, `is_fixed`, `max_contribution`, `is_pretax`, `has_employer_match`, `compounding_periods`) VALUES (6, 'roth_ira', 1, 0, 7000, 0, 0, NULL);
...
INSERT INTO `vehicle` (`id`, `asset_name`, `is_qualified`, `is_fixed`, `max_contribution`, `is_pretax`, `has_employer_match`, `compounding_periods`) VALUES (12, 'investment_property', 0, 1, NULL, 0, 0, NULL);
...
INSERT INTO `vehicle` (`id`, `asset_name`, `is_qualified`, `is_fixed`, `max_contribution`, `is_pretax`, `has_employer_match`, `compounding_periods`) VALUES (14, 'profit_sharing', 0, 0, NULL, 0, 0, NULL);
INSERT INTO `vehicle` (`id`, `asset_name`, `is_qualified`, `is_fixed`, `max_contribution`, `is_pretax`, `has_employer_match`, `compounding_periods`) VALUES (15, 'money_purchase', 0, 0, NULL, 0, 0, NULL);
INSERT INTO `vehicle` (`id`, `asset_name`, `is_qualified`, `is_fixed`, `max_contribution`, `is_pretax`, `has_employer_match`, `compounding_periods`) VALUES (16, 'mutual_fund', 0, 0, NULL, 0, 0, NULL);
